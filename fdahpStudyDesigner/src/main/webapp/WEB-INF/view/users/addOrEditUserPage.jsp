                    ...
                    <c:if test="${empty userBO.userPassword}">
                        <div class="dis-inline mt-sm">
							<span class="black-sm-f">Status:<span
									...
									Account Activation Pending</span></span><span
                                class="black-sm-f resend pl-md"><a
                ...
                <div class="edit-user-list-widget">
                    ...
                    <span class="pull-right">
						...
						<span class="radio radio-inline"> <input type="radio"
                                                                 class="musr" id="inlineRadio2"
                                                                 value="1" name="manageUsers"
                ...
                <div class="dis-line text-right ml-md">
                    ...
                    <c:if test="${actionPage eq 'ADD_PAGE'}">
                        <div class="dis-line form-group mb-none">
                            <button type="button" class="btn btn-primary blue-btn addUpdate">Add
                            </button>
                        </div>
                    </c:if>
                    <c:if test="${actionPage eq 'EDIT_PAGE'}">
                        <div class="dis-line form-group mb-none">
                            <button type="button" class="btn btn-primary blue-btn addUpdate">
                                Update
                            </button>
                        </div>
                    </c:if>
    ...
    $("#emailId").blur(function () {
      ...
      if (isEmail && ('' === oldEmail || ('' !== oldEmail && oldEmail !== email))) {
        ...
        $('#emailId').parent().find(".help-block").append(
            $("<ul <li></li></ul>").attr("class", "list-unstyled"));
        if (email !== '') {
          $.ajax({
    ...
    $(".study-addbtn").click(function () {
      ...
      if (count == tot_items) {
        $(".study-list .bootstrap-select .dropdown-menu ul.dropdown-menu").empty().append(
            $("<li> </li>").attr("class", "text-center").text(
