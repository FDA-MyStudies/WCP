            ...
            <div>
                ...
                <div class="row form-group">
                    <div class="col-md-6 pl-none">
                        ...
                        <div class="gray-xs-f mb-xs">Group ID <span class="requiredStar">*</span> <span
                        ...
                        <div class="form-group">
                            <input type="text" type="text" class="form-control req" placeholder="Enter group ID"
                                   name="groupId" id="groupId" value="${fn:escapeXml(groupsBo.groupId)}"
                    ...
                    <div class="col-md-6 pl-none">
                        <div class="gray-xs-f mb-xs">Group Name <span class="requiredStar">*</span> <span
                                class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip" title=""
                        ...
                        <div class="form-group">
                            <input type="text" type="text" class="form-control req" placeholder="Enter group name"
                                   name="groupName" id="groupName" value="${fn:escapeXml(groupsBo.groupName)}" required
                                <c:if test="${currLanguage eq 'es'}">
                                    <c:out value="disabled='disabled'"/>
                                </c:if>>
                            <div class="help-block with-errors red-txt"></div>
                            ...
                            <div style="height: 100px; border:1px solid #bfdceb;">
                                ...
                                <div class="row data-div">
                                    ...
                                    <div class="col-md-3 form-group">
                                        ...
                                        <input type="text" required class="form-control value" id="value0"
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div id="autoSavedMessage" class="text-right">
                        ...
                        <div class="grey_txt"><span class="timerPos"><img src="../images/timer2.png"/></span>Your
                            session expires in <span class="bold_txt">15 minutes</span></div>
                    </div>
                </div>
            </div>
        </div>
