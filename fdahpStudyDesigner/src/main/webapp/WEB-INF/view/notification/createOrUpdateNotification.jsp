		...
		<div class="white-bg box-space t-bor text-right">
			<div class="dis-line text-right ml-md">
				...
				<div class="dis-line form-group mb-none mr-sm">
					<button type="button"
							class="btn btn-default gray-btn backOrCancelBtnOfNotification">Cancel
					</button>
				</div>
				<c:if
