...
<div class="col-sm-10 col-rc white-bg p-none">
    <form:form
            action="/fdahpStudyDesigner/adminStudies/saveOrDoneChecklist.do?${_csrf.parameterName}=${_csrf.token}&_S=${param._S}"
            id="checklistForm" role="form" method="post" autocomplete="off"
        ...
        <div class="right-content-head">
            <div class="text-right">
                <div class="black-md-f dis-line pull-left line34"><span
                        class="pr-sm">Checklist</span></div>
                <div class="dis-line form-group mb-none mr-sm">
                    <button type="button" class="btn btn-default gray-btn cancelBut">Cancel</button>
                </div>
                <c:if test="${empty permission}">
                    <div class="dis-line form-group mb-none mr-sm">
                        <button type="button" class="btn btn-default gray-btn" id="saveChecklistId">
                            Save
                        </button>
                    </div>

                    <div class="dis-line form-group mb-none">
                        <button type="button" class="btn btn-primary blue-btn" id="doneChecklistId">
                            Done
                        </button>
                    </div>
                </c:if>
        ...
        <div class="new-checkbox right-content-body">
            ...
            <div class="checkbox__container pl-3 pt-lg">
                ...
                <div class="checkbox checkbox-inline p-45 pb-md">
                    <div>
                        <input type="checkbox" id="inlineCheckbox4" class="class" name="checkbox4"
                               <c:if test="${checklist.checkbox4}">checked</c:if> required>
                ...
                <div class="checkbox checkbox-inline p-45 pb-md">
                    <div>
                        ...
                        <label for="inlineCheckbox6"> App Install and Study Start Instructions
                            Provided </label>
                    </div>
                    <div class=" pl-13">
                ...
                <div class="checkbox checkbox-inline p-45 pb-md">
                    <div>
                        ...
                        <label for="inlineCheckbox7"> Appearance of full consent document - Reviewed
                            and Confirmed </label>
                    </div>
                    <div class=" pl-13">
                ...
                <div class="checkbox checkbox-inline p-45 pb-md">
                    <div>
                        ...
                        <label for="inlineCheckbox11"> Standalone Study App - Tested and
                            Verified </label>
                    </div>
                    <div class=" pl-13">
                ...
                <div class="checkbox checkbox-inline p-45 pb-md">
                    <div>
                        ...
                        <label for="inlineCheckbox12"> Standalone Study App - Approved and Live on
                            App Store/Play Store</label>
                    </div>
                    <div class=" pl-13">
