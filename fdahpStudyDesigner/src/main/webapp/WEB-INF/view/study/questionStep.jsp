			...
			<div class="tab-content pl-xlg pr-xlg">
				...
				<input type="hidden" id="currentLanguage" name="language"
					   value="${currLanguage}"> <input type="hidden" id="mlName"
													   value="${studyLanguageBO.name}"/> <input
					type="hidden"
				...
				<input type="hidden" id="mlQuestion"
					   value="${questionLangBO.question}"> <input type="hidden"
																  id="mlDescription"
																  value="${questionLangBO.description}">
				<input
					...
					value="${questionLangBO.displayText}"> <input type="hidden"
																  id="mlPlaceholderText"
																  value="${questionLangBO.placeholderText}">
				<input
				...
				<input type="hidden" id="mlInvalidMessage"
					...
					value="${questionLangBO.exceptText}"> <input type="hidden"
																 id="mlChartTitle"
																 value="${questionLangBO.chartTitle}">
				<input
				...
				<input
						type="hidden" id="mlOtherDescription"
						value="${questionLangBO.otherDescription}">
				<input
						type="hidden" id="mlOtherPlaceholderText"
						value="${questionLangBO.otherPlaceholderText}">
				...
				<input type="hidden" id="stepOrGroupPostLoad"
					   value="${questionnairesStepsBo.stepOrGroupPostLoad}"
					   name="stepOrGroupPostLoad"/>
				<input type="hidden" id="stepOrGroup" value="${questionnairesStepsBo.stepOrGroup}"
					   name="stepOrGroup"/>
				<div id="sla" class="tab-pane fade in show active mt-xlg">
							...
							<div class="col-md-4 col-lg-3 p-none">
								...
								<div class="form-group">
									<select name="destinationStep" id="destinationStepId"
										...
										<c:forEach items="${groupsListPostLoad}" var="group"
												   varStatus="status">
					...
					<div>
						...
						<div>
							<input type="hidden" id="defaultVisibility"
								   name="groupDefaultVisibility"
								   value="${questionnairesStepsBo.defaultVisibility}"/>
							<label class="switch bg-transparent mt-xs">
								...
								<c:if test="${empty questionnairesStepsBo.defaultVisibility || questionnairesStepsBo.defaultVisibility eq 'true'}">
									   checked</c:if>>
					...
					<div id="logicDiv">
						...
						<div class="row">
							...
							<div class="col-md-3 mt__8">
                                ...
                                <span class="checkbox checkbox-inline">
									<input type="checkbox" id="differentSurveyPreLoad"
										   name="differentSurveyPreLoad"
						...
						<div class="row">
							...
							<div class="col-md-5 form-group dis-none" id="content">
								<select class="selectpicker text-normal" name="preLoadSurveyId"
									...
									<c:forEach items="${questionnaireIds}" var="key"
											   varStatus="loop">
										<option data-id="${key.id}" value="${key.id}"
												id="${key.shortTitle}"
						...
						<div class="row">
							...
							<div class="col-md-5 form-group">
								<select name="destinationTrueAsGroup" id="destinationTrueAsGroup"
										required
										data-error="Please select an option"
										class="selectpicker text-normal" required
										title="-select destination step-">
									<c:forEach items="${sameSurveyPreloadSourceKeys}"
											   var="destinationStep">
										<option value="${destinationStep.stepId}" data-type="step"
											...
											Step ${destinationStep.sequenceNo}
											: ${destinationStep.stepShortTitle}
										</option>
									</c:forEach>
									<option value="0" data-type="step"
									...
									<c:forEach items="${groupsListPreLoad}" var="group"
											   varStatus="status">
										<option value="${group.id}" data-type="group"
												id="selectGroup${group.id}"
						...
						<div id="formulaContainer${status.index}">
							<c:choose>
								<c:when test="${questionnairesStepsBo.preLoadLogicBeans.size() gt 0}">
									<c:forEach items="${questionnairesStepsBo.preLoadLogicBeans}"
										...
										<div id="form-div${status.index}"
											...
											<c:if test="${status.index gt 0}">
												...
												<span class="radio radio-info radio-inline p-45 pl-2">
													<input type="radio" id="andRadio${status.index}"
														   value="&&" class="con-radio con-op-and"
											...
											<div class="row data-div">
												...
												<div class="col-md-2 form-group">
													<select class="selectpicker operator text-normal"
															...
															required
															id="operator0"
															name="preLoadLogicBeans[0].operator"
															title="-select-">
														<c:forEach items="${operators}"
																   var="operator">
				...
				<div id="qla" class="tab-pane fade mt-xlg">
					...
					<div class="row">
						<button type="button" class="btn btn-primary blue-btn" id="pbutton">Piping
						</button>
					</div>
					<br>
					<div class="clearfix"></div>
						...
						<c:choose>
							<c:when test="${questionnairesStepsBo.questionsBo.useAnchorDate}">
								...
								<div class="col-md-6 p-none useAnchorDateName mt-md dis-none"
									 >
									<div class="gray-xs-f mb-xs">
										Define name for Anchor date<span
					...
					<c:if test="${fn:contains(studyBo.platform, 'I')}">
						<div class="clearfix"></div>
						<div class="mb-lg dis-none" id="allowHealthKitId">
							<span class="checkbox checkbox-inline pl-1"> <input
					...
					<c:if test="${questionnaireBo.frequency ne 'One time'}">
						<div class="bor-dashed mt-none mb-md dis-none" id="borderHealthdashId"
							 ></div>
					...
					<div class="clearfix"></div>
					<div class="bor-dashed mt-none mb-md dis-none" id="borderdashId"
						 ></div>
					<div class="clearfix"></div>
					...
					<div id="responseTypeDivId">
						...
						<div id="Scale" class="dis-none">
							...
							<div class="row mb-xs">
									...
									<div class="col-md-9 col-lg-9 p-none">
										...
										<div class="form-group">
											<c:if
												...
												<input type="text"
													   class="form-control ScaleRequired"
								...
								<div class="col-md-6">
									<div class="col-md-9 col-lg-9 p-none">
										<div class="gray-xs-f mb-xs">
											Number of Steps <span class="requiredStar">*</span>
											<span
													class="ml-xs sprites_v3 filled-tooltip"
													data-toggle="tooltip"
								...
								<div class="col-md-6 pl-none">
									<div class="col-md-6 col-lg-6 pl-none">
										...
										<div class="form-group col-smthumb-2">
											...
											<!-- onclick="openUploadWindow(this);" -->
												<div class="thumb-img">
													<img
															...
															class="imageChoiceWidth questStepThumbnailImg"/>
												...
												<c:if
													...
													<div class="textLabelscaleMinImagePathId">
														Upload
													</div>
												</c:if>
												<c:if
											...
											<input type="hidden"
												   name="questionReponseTypeBo.minImage"
												   id="scaleMinImagePathId"
												   value="${questionnairesStepsBo.questionReponseTypeBo.minImage}">
											<span id="removeUrl"
												  class="blue-link elaborateHide removeImageId <c:if test="${empty questionnairesStepsBo.questionReponseTypeBo.minImage}">hide</c:if> removeImageFunct">X
										...
										<div class="form-group col-smthumb-2">
											...
											<!-- onclick="openUploadWindow(this);" -->
												...
												<c:if
													...
													<div class="textLabelscaleMaxImagePathId">
														Upload
													</div>
												</c:if>
												<c:if
											...
											<input class="dis-none upload-image" data-imageId='1'
												   ...
												   onchange="readURL(this);">
											<input type="hidden"
												   name="questionReponseTypeBo.maxImage"
												   id="scaleMaxImagePathId"
												   value="${questionnairesStepsBo.questionReponseTypeBo.maxImage}">
											<span id="removeUrl"
												  class="blue-link elaborateHide removeImageId <c:if test="${empty questionnairesStepsBo.questionReponseTypeBo.maxImage}">hide</c:if> removeImageFunct"
												  >X<a
									...
									<div class="col-md-6 col-lg-6 pl-none">
										...
										<div class="form-group col-smthumb-2">
											...
											<input type="hidden"
												   ...
												   value="${questionnairesStepsBo.questionReponseTypeBo.minImage}">
											<span id="removeUrl"
												  class="blue-link elaborateHide removeImageId <c:if test="${empty questionnairesStepsBo.questionReponseTypeBo.minImage}">hide</c:if> removeImageFunct"
												  >X<a
													href="javascript:void(0)"
													class="blue-link txt-decoration-underline pl-xs">Remove
													Image</a></span>
							...
							<div class="row">
								<div class="col-md-6 pl-none">
									<div class="col-md-8 col-lg-8 p-none">
										...
										<div class="form-group">
											<input type="text" class="form-control lang-specific"
												   name="questionReponseTypeBo.unit"
												   id="numericUnitId"
						...
						<div id="Date" class="dis-none">
							...
							<div id="customDateContainerId"
								 <c:if test="${questionnairesStepsBo.questionReponseTypeBo.selectionStyle eq 'Until current date' || questionnairesStepsBo.questionReponseTypeBo.selectionStyle eq 'After current date'}">class="dis-none"</c:if>>
								<div class="row">
									<div class="col-md-6 pl-none">
										<div class="col-md-8 col-lg-8 p-none">
											<div class="gray-xs-f mb-xs">
											...
											<c:forEach
												...
												<div class="value-picker row form-group mb-xs"
													...
													<div class="col-md-2 pl-none mt__6">
														<span class="addBtnDis addbtn mr-sm align-span-center addValuePickerFunct">+</span>
														<!-- onclick='addValuePicker();' -->
														<span
																class="delete vertical-align-middle remBtnDis hide pl-md align-span-center removeValuePickerFunct"></span>
														...
														<c:when
															...
															<span class='tool-tip'
																  ...
																  title='Only a max of 8 rows are allowed'><span
																	class='addBtnDis addbtn mr-sm align-span-center cursor-none addTextScaleFunct'>+</span>
												...
												<div class="col-md-3 pl-none">
													<div class="form-group">
														<select
															...
															<c:forEach items="${groupsListPostLoad}"
																	   var="group"
																	   varStatus="status">
																<option value="${group.id}"
																		id="selectGroup${group.id}"
									...
									<c:when
										...
										<c:forEach
                                            ...
                                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
												 width="14.000000pt" height="9.000000pt"
                                          ...
                                          <textarea class="form-control lang-specific"
													...
													maxlength="150">${fn:escapeXml(questionResponseSubType.description)}</textarea>
																			...
																			<div class="col-md-2 pl-none">
                                        <span class="addBtnDis addbtn align-span-center addTextChoiceFunct">+</span>
                                        <!-- onclick='addTextChoice();' -->
                                         <span
																					class="delete vertical-align-middle remBtnDis hide pl-md align-span-center removeTextChoiceFunct"></span>
                    ...
                    <td> <input type="text" class="index1 reset_val"  value="1" /> </td> -->
                        ...
                        <div id="collapse1" class="panel-collapse collapse in">
							...
							<div>
								...
								<div class="textchoiceOtherCls" class="dis-none">
									<!-- Section Start  -->
									<div class="row mt-xlg">
										<div class="col-md-3 pl-none">
											<div class="gray-xs-f mb-xs">
										...
										<div class="col-md-3 pl-none">
											...
											<div class="form-group mb-none">
												<input type="text"
													   class="form-control TextChoiceRequired text-choice-other textChoiceVal"
									...
									<div class="mt-lg">
										<div>
											<span class="gray-xs-f mb-xs pr-md">Include text field
												...
												type="radio" class="otherIncludeTextCls"
												id="otherYes"
												value="Yes"
									...
									<div class="OtherOptionCls" class="dis-none">
										<div class="clearfix"></div>
										<div class="col-md-6 p-none mt-md">
											...
											<div class="form-group">
												<input type="text"
													   class="form-control lang-specific"
									...
									<c:forEach
										...
										<div class="image-choice row" id="${subtype.index}">
											...
											<div class="col-md-2 pl-none mt-sm mt__8">
													<span class="addBtnDis addbtn mr-sm align-span-center addImageChoiceFunct">+</span>
													<!-- onclick='addImageChoice();' -->
													 <span
													class="delete vertical-align-middle remBtnDis hide pl-md align-span-center removeImageChoiceFunct"></span>
													...
													<div class="numeric__define_input gray__t">
														<div class="numeric__row display__flex__base-webkit"
															...
															<div class="form-group sm-selection">
																...
																<div class="mt-sm black-xs-f italic-txt red-txt dis-none"
																	 id="inputTypeErrorValueId2"></div>
																<div class="help-block with-errors red-txt"></div>
																<input type="hidden"
																...
																<c:forEach
																	...
																	<div class="numeric__row display__flex__base"
																		...
																		<div class="form-group sm-selection">
																			...
																			<div class="mt-sm black-xs-f italic-txt red-txt dis-none"
																				 id="inputTypeErrorValueId${questionConditionsSubBranchBo.sequenceNo}"></div>
																			<div class="help-block with-errors red-txt"></div>
																			<input type="hidden"
																			...
																			<c:choose>
																				<c:when
																					...
																					<div class="add_varible add_var_hide addVariableFunct"
																						 index="${status.index}"
																				...
																				<c:otherwise>
																					<div
																							class="add_varible <c:if test="${!subStatus.last}">add_var_hide</c:if> addVariableFunct"
																							index="${status.index}"
																							parentIndex="${questionConditionBranchBo.sequenceNo}"
																							id="addVaraiable${subStatus.index}">
																						+ Add
																		...
																		<div class="form-group sm__in">
																			<c:choose>
																				...
																				<c:otherwise>
																						<span
																								class="delete vertical-align-middle remBtnDis pl-md align-span-center <c:if test="${childCount eq 2}">hide</c:if> removeVaraiableFunct"
																								index="${questionConditionsSubBranchBo.sequenceNo}"
																								count="${subStatus.index}"></span>
																								<!-- onclick="removeVaraiable(this);" -->
																				</c:otherwise>
																			</c:choose>
																		</div>
																	</div>
...
<div class="modal fade" id="pipingModal" role="dialog">
	<div class="modal-dialog modal-lg">
		<div class="modal-content" id="mrg-left">
			...
			<div class="modal-body pt-xs pb-lg pl-xlg pr-xlg">
				...
				<div class="mb-xs">
					<input type="hidden" id="isSaved"
						   value="${questionnairesStepsBo.pipingSnippet}">
				...
				<div class="mb-xs">
					<select class="selectpicker text-normal req" name="pipingSourceQuestionKey"
						...
						<c:if test="${sameSurveyPipingSourceKeys eq null || sameSurveyPipingSourceKeys.size() eq 0}">
							<option class="txt-al" disabled>- No items
								found -
							</option>
						</c:if>
					</select>
...
<script type="text/javascript" nonce="${nonce}">
	...
	$(document).ready(function () {
		...
		$('#textchoiceOtherId').click(function () {
			...
			if ($(this).is(':checked')) {
				...
				} else if (displayText1.length <= 0 && displayValue1.length <= 0
						&& exclusive1.length
		...
		$("#doneId").click(function () {
			...
			if ($('#isSaved').val() !== '') {
				...
				if ($('#pipingSnippet').val() === '') {
					$('#pipingSnippet').parent().addClass('has-error has-danger').find(
							".help-block")
					.empty()
					.append($("<ul><li> </li></ul>")
					.attr("class", "list-unstyled")
				...
				if ($('#differentSurvey').is(':checked') && $('#surveyId').val() === '') {
					$('#surveyId').closest('div.mb-xs').addClass('has-error has-danger').find(
							".help-block")
					.empty()
					.append($("<ul><li> </li></ul>")
					.attr("class", "list-unstyled")
			...
			if (isFromValid("#questionStepId")) {
				if (!$('#groupDefaultVisibility').is(':checked')) {
					$('#stepOrGroup').val(
							$('#destinationTrueAsGroup option:selected').attr('data-type'));
				}
				...
				if (resType == "Email") {
					...
					if ((minValue != '' && maxValue != '') || (minValue == '' && maxValue == '')) {
						...
						if (maxValue == '') {
							$("#numericMaxValueId").parent().addClass("has-danger").addClass(
									"has-error");
						...
						if (minValue == '') {
							$("#numericMinValueId").parent().addClass("has-danger").addClass(
									"has-error");
					...
					if ((minValue != '' && maxValue != '') || (minValue == '' && maxValue == '')) {
						...
						if (maxValue == '') {
							if (resType == "Continuous Scale") {
								$("#continuesScaleMaxDescriptionId").parent().addClass(
										"has-danger").addClass(
										"has-error");
								$("#continuesScaleMaxDescriptionId").parent().find(
										".help-block").empty();
								$("#continuesScaleMaxDescriptionId").parent().find(
										".help-block").append(
								...
								$("#scaleMaxDescriptionId").parent().addClass(
										"has-danger").addClass(
										"has-error");
						...
						if (minValue == '') {
							if (resType == "Continuous Scale") {
								$("#continuesScaleMinDescriptionId").parent().addClass(
										"has-danger").addClass(
										"has-error");
								$("#continuesScaleMinDescriptionId").parent().find(
										".help-block").empty();
								$("#continuesScaleMinDescriptionId").parent().find(
										".help-block").append(
										$("<ul><li> </li></ul>").attr("class",
								...
								$("#scaleMinDescriptionId").parent().addClass(
										"has-danger").addClass(
										"has-error");
					...
					if (resType == "Continuous Scale") {
						...
						minImageFile = document.getElementById(
								"continuesScaleMinImageFileId").files[0];
						maxImageFile = document.getElementById(
								"continuesScaleMaxImageFileId").files[0];
					} else {
					...
					if (minImagePath == '' && maxImagePath == '' && ((typeof minImageFile
							== 'undefined'
							&& typeof maxImageFile == 'undefined') || (minImageFile == null
							&& maxImageFile
							== null))) {
						isImageValid = true;
						...
						if (maxImagePath == '' && (maxImageFile == '' || typeof maxImageFile
								== 'undefined'
								|| maxImageFile == null)) {
							if (resType == "Continuous Scale") {
								$("#continuesScaleMaxImagePathId").parent().addClass(
										"has-danger").addClass(
										"has-error");
								$("#continuesScaleMaxImagePathId").parent().find(
										".help-block").empty();
								$("#continuesScaleMaxImagePathId").parent().find(
										".help-block").append(
										$("<ul><li> </li></ul>").attr("class",
								...
								$("#scaleMaxImagePathId").parent().addClass("has-danger").addClass(
										"has-error");
						...
						if (minImagePath == '' && (minImageFile == '' || typeof minImageFile
								== 'undefined'
								|| minImageFile == null)) {
							if (resType == "Continuous Scale") {
								$("#continuesScaleMinImagePathId").parent().addClass(
										"has-danger").addClass(
										"has-error");
								$("#continuesScaleMinImagePathId").parent().find(
										".help-block").empty();
								$("#continuesScaleMinImagePathId").parent().find(
										".help-block").append(
										$("<ul><li> </li></ul>").attr("class",
								...
								$("#scaleMinImagePathId").parent().addClass("has-danger").addClass(
										"has-error");
					...
					if (anchorDateUsed && anchorText != '' && anchorText != null
							&& typeof anchorText
							!= 'undefined') {
						...
						if (val) {
							...
							if (statShortName != '' && statShortName != null && typeof statShortName
								...
								validateStatsShorTitle('', function (val) {
									if (val) {
										if (resType != '' && resType != null && resType
												!= 'undefined') {
				...
				if (value != '') {
					if (parseInt(value) >= -10000 && parseInt(value) <= 10000) {
						if (parseInt(value) + 1 > parseInt(maxValue)) {
							$("#scaleMinValueId").val('');
							$("#scaleMinValueId").parent().addClass("has-danger").addClass(
									"has-error");
							$("#scaleMinValueId").parent().find(".help-block").empty();
							...
							$("#scaleMinValueId").parent().removeClass("has-danger").removeClass(
									"has-error");
							$("#scaleMinValueId").parent().find(".help-block").empty();
						}
					} else {
				...
				if (value != '') {
					if (parseInt(value) >= -10000 && parseInt(value) <= 10000) {
						if (parseInt(value) >= parseInt(minValue) + 1 && parseInt(value) <= 10000) {
							$("#scaleMaxValueId").parent().removeClass("has-danger").removeClass(
									"has-error");
							$("#scaleMaxValueId").parent().find(".help-block").empty();
						} else if (parseInt(value) < parseInt(minValue) + 1) {
							$("#scaleMaxValueId").val('');
							$("#scaleMaxValueId").parent().addClass("has-danger").addClass(
									"has-error");
							$("#scaleMaxValueId").parent().find(".help-block").empty();
			...
			if (value != '' && minValue != '' && maxValue != '') {
				...
				if ((parseInt(diff) % parseInt(value)) == 0) {
					...
					if (parseInt(stepsCount) >= 1 && parseInt(stepsCount) <= 13) {
						$("#displayStepsCount").parent().removeClass("has-danger").removeClass(
								"has-error");
						$("#displayStepsCount").parent().find(".help-block").empty();
						...
						$("#scaleStepId").val('');
						$("#displayStepsCount").val('');
						$("#displayStepsCount").parent().addClass("has-danger").addClass(
								"has-error");
						$("#displayStepsCount").parent().find(".help-block").empty();
		...
		$("#scaleDefaultValueId").blur(function () {
			...
			if (value != '' && stepSize != '') {
				if (parseInt(value) >= 0 && parseInt(value) <= parseInt(stepSize)) {
					$("#scaleDefaultValueId").parent().removeClass("has-danger").removeClass(
							"has-error");
					$("#scaleDefaultValueId").parent().find(".help-block").empty();
				} else {
					$("#scaleDefaultValueId").val('');
			...
			if (maxValue != '') {
				if (parseInt(value) >= -10000 && parseInt(value) <= 10000) {
					if (parseInt(value) + 1 > parseInt(maxValue)) {
						...
						$("#continuesScaleMinValueId").parent().removeClass(
		...
		$("#continuesScaleMaxValueId").blur(function () {
			...
			if (minValue != '') {
				if (parseInt(value) >= -10000 && parseInt(value) <= 10000) {
					if (parseInt(value) >= parseInt(minValue) + 1 && parseInt(value) <= 10000) {
						$("#continuesScaleMaxValueId").parent().removeClass(
								"has-danger").removeClass(
								"has-error");
						$("#continuesScaleMaxValueId").parent().find(".help-block").empty();
					} else if (parseInt(value) < parseInt(minValue) + 1) {
		...
		$("#continuesScaleDefaultValueId").blur(function () {
			...
			$(this).parent().find(".help-block").empty();
			if (value != '') {
				if (parseInt(value) >= parseInt(minValue) && parseInt(value) <= parseInt(
						maxValue)) {
					$(this).parent().removeClass("has-danger").removeClass("has-error");
					$(this).parent().find(".help-block").empty();
				} else {
		...
		$("#textScalePositionId").blur(function () {
			...
			if (value != '') {
				if (value >= 1 && value <= count) {
					$("#textScalePositionId").parent().removeClass("has-danger").removeClass(
							"has-error");
					$("#textScalePositionId").parent().find(".help-block").empty();
				} else {
		...
		$(document).on('change', '.upload-image', function (e) {
			...
			if ((file = this.files[0])) {
				...
				img.onload = function () {
					var ht = this.height;
					var wds = this.width;
					if ((parseInt(ht) == parseInt(wds)) && (parseInt(ht) >= 90 && parseInt(ht)
									<= 120)
							&& (parseInt(wds) >= 90 && parseInt(wds) <= 120)) {
						$(thisAttr).parent().find('.form-group').removeClass(
						...
						$(thisAttr).parent().find('img').attr("src",
		 ...
		 $(".questStepThumbnailImg").on('error', function() {
							...
							if (message == "SUCCESS") {
								...
								if (formulaResponseJsonObject.outPutData == 'true'
									...
									$('#outputId').empty().append(
											$("<font> </font>").attr("class",
													"gtxtf").empty().append(
													$("<B> </B>").text(
															formulaResponseJsonObject.outPutData)));
								} else {
									$('#outputId').empty().append(
											$("<font> </font>").attr("class",
													"rtxtf").empty().append(
								...
								if (typeof formulaResponseJsonObject != 'undefined'
										&& typeof formulaResponseJsonObject.statusMessage
										!= 'undefined') {
			...
			if (Number(id) != Number(previousResponseType)) {
				...
				if (responseType != 'Boolean') {
					...
					if (responseType == "Date") {
						var datePicker = $("#" + responseType.replace(/\s/g, '')).find(
								'input:text').data(
								"DateTimePicker");
					...
					if (responseType == 'Image Choice') {
						...
						$("#" + responseType.replace(/\s/g, '')).find('img').attr("src",
								"../images/icons/sm-thumb.jpg");
						$("#" + responseType.replace(/\s/g, '')).find("input:hidden").each(
								function () {
									$("#" + this.id).val('');
								});
					}
				...
				if (dashboard == 'true') {
					...
					if ($("#addLineChart").is(":checked")) {
						...
						if (document.getElementById("allowRollbackChartNo") != null
								&& typeof document.getElementById("allowRollbackChartNo")
								!= 'undefined') {
							document.getElementById("allowRollbackChartNo").checked = true;
						}
						$('#chartTitleId').val('');
	...
	function saveQuestionStepQuestionnaire(item, callback) {
		...
		if (resType == "Scale") {
			...
			formData.append('minImageFile',
					document.getElementById("scaleMinImageFileId").files[0]);
			formData.append('maxImageFile',
					document.getElementById("scaleMaxImageFileId").files[0]);
			...
			var multiple_lines = $(
					'input[name="questionReponseTypeBo.multipleLines"]:checked').val();
			...
			$('.text-choice').each(function () {
				...
				questionSubResponseType.displayTextLang = $(
						"#displayTextChoiceTextLang" + id).val();
				questionSubResponseType.descriptionLang = $(
						"#displayTextChoiceDescriptionLang" + id).val();
				questionSubResponseArray.push(questionSubResponseType);
				questionReponseTypeBo.otherType = $(
						'[name="questionReponseTypeBo.otherType"]:checked').val();
				questionReponseTypeBo.otherText = $(
						'[name="questionReponseTypeBo.otherText"]').val();
				questionReponseTypeBo.otherValue = $(
						'[name="questionReponseTypeBo.otherValue"]').val();
		...
		if ($("#formulaBasedLogicId").is(":checked")) {
			var questionConditionBranchBoArray = [];
			$('.numeric__section').each(function (i) {

				var questionConditionBranchBoList = {};
		...
		if (!$('#groupDefaultVisibility').is(':checked')) {
			questionnaireStep.stepOrGroup = $('#destinationTrueAsGroup option:selected').attr(
					'data-type');
		}
		if ('${questionnaireBo.branching}' === 'true') {
		...
		if (quesstionnaireId && shortTitle) {
			...
			if ($('#isAutoSaved').val() === 'true' && $('#pipingModal').hasClass('show')
				...
				object.pipingSourceQuestionKey = $('#sourceQuestion option:selected').attr(
						'data-id');
							...
							let lastSavedInterval = setInterval(function () {
								if ((i === 15) || (j === 0)) {
									$('#autoSavedMessage').html(
											'<div class="blue_text">Last saved was ' + i
									...
									if ((i === 1) || (j === 14)) {
										...
										$('#autoSavedMessage').html(
												'<div class="blue_text">Last saved was ' + i
												+ ' minutes ago</div><div class="grey_txt"><span class="timerPos"><img src="../images/timer2.png"/></span>Your session expires in <span class="bold_txt"> '
												+ j + ' minutes</span></div>').css("fontSize",
												"15px");
									}
									idleTime = 0;
									i += 1;
	...
	//function addValuePicker() {
		...
		<c:forEach items="${groupsListPostLoad}" var="group" varStatus="status">
		newValuePicker += "<option value='${group.id}' id='selectGroup${group.id}'>Group :  ${group.groupName}&nbsp;</option>";
		</c:forEach>
		...
		newValuePicker += "<div class='col-md-2 pl-none mt__6'>" +
				"   <span class='addBtnDis addbtn mr-sm align-span-center addValuePickerFunct'>+</span>"
				+
				"<span class='delete vertical-align-middle remBtnDis hide pl-md align-span-center removeValuePickerFunct'></span>"
				+
				"</div>" +
				"</div>";
	...
	//function addTextScale() {
		...
		if ($('.text-scale').length < 8) {
			...
			newTextScale += " <div class='col-md-3 pl-none'>" +
					"    <div class='form-group'>" +
					"       <select class='selectpicker' name='questionResponseSubTypeList["
					+ scaleCount
			...
			<c:forEach items="${groupsListPostLoad}" var="group" varStatus="status">
			newTextScale += "<option value='${group.id}' id='selectGroup${group.id}'>Group :  ${group.groupName}&nbsp;</option>";
			</c:forEach>
	...
	//function addTextChoice() {
		...
		var newTextChoice = "<tr class='text-choice' id='" + choiceCount + "''>"
				...
				+ choiceCount + "].sequenceNumber' id='displayTextChoicesequenceNumber"
				+ choiceCount
				+ "' value='" + (choiceCount + 1) + "' />"
		...
		<c:forEach items="${groupsListPostLoad}" var="group" varStatus="status">
		newTextChoice += "<option value='${group.id}' id='selectGroup${group.id}'>Group :  ${group.groupName}&nbsp;</option>";
		</c:forEach>
		newTextChoice += "<option value='0'>Completion Step</option>" +
				"</select>" +
				"  <div class='help-block with-errors red-txt'></div>" +
		...
		newTextChoice += "<div class='col-md-12 p-none display__flex__'><div class='col-md-10 pl-none'>"
				...
				"   <span class='addBtnDis addbtn align-span-center addTextChoiceFunct'>+</span>"
				+
				"	 <span class='delete vertical-align-middle remBtnDis hide pl-md align-span-center removeTextChoiceFunct'></span>"
				+
				"</div></div>" +
	...
	//function addImageChoice() {
		...
		<c:forEach items="${groupsListPostLoad}" var="group" varStatus="status">
		newImageChoice += "<option value='${group.id}' id='selectGroup${group.id}'>Group :  ${group.groupName}&nbsp;</option>";
		</c:forEach>
		...
		newImageChoice += "<div class='col-md-2 pl-none  mt__8'>" +
				"   <span class='addBtnDis addbtn mr-sm align-span-center addImageChoiceFunct'>+</span>"
				+
				"	  <span class='delete vertical-align-middle remBtnDis hide pl-md align-span-center removeImageChoiceFunct'></span>"
				+
				"</div>" +
				"</div> ";
				...
				$.ajax({
					...
					success: function getResponse(data) {
						...
						if ('SUCCESS' != message) {
							...
							$("#statShortNameId").parent().removeClass("has-danger").removeClass(
									"has-error");
							$("#statShortNameId").parent().find(".help-block").empty();
							if (callback)
								callback(true);
							...
							$("#statShortNameId").val('');
							$("#statShortNameId").parent().addClass("has-danger").addClass(
									"has-error");
							$("#statShortNameId").parent().find(".help-block").empty();
	...
	function validateFractionDigits(item) {
		...
		if (value != '') {
			if (minValue != '' && maxValue != '') {
				...
				maxFracDigits = (parseInt(maxTemp) > parseInt(minTemp)) ? parseInt(minTemp)
						: parseInt(
								maxTemp);
				...
				if (parseInt(value) <= parseInt(maxFracDigits)) {
					...
					if (defaultValue != '') {
						$("#continuesScaleDefaultValueId").val(
								parseFloat(defaultValue).toFixed(value));
					}
				} else {
					$(item).val('');
					$(item).parent().addClass("has-danger").addClass("has-error");
			...
			$('.text-choice, .text-choice-other').each(function () {
				...
				if (id === 'textchoiceOtherValue') {
					if ($('#textchoiceOtherId').is(':checked')) {
						...
						if (otherValue !== '' && valueArrayTxtChoice.indexOf(
								otherValue.toLowerCase()) !== -1) {
					...
					if (valField !== '' && valField !== undefined) {
						$("#displayTextChoiceValue" + id).parent().removeClass(
						...
						if (valueArrayTxtChoice.indexOf(valField.toLowerCase()) !== -1) {
							...
							$("#displayTextChoiceValue" + id).parent().addClass(
									"has-danger").addClass(
									"has-error");
							$("#displayTextChoiceValue" + id).parent().find(".help-block").empty();
	...
	function addFunctions(item) {
		...
		if (value === "F") {
			...
			var addFunction = "<div class='numeric__section' id='rootId" + index + "'>" +
					...
					+ rowCount + "].inputTypeValue' id='inputTypeValueId" + rowCount + "' index='"
					+ index
			...
			addFunction += "      </select>" +
					...
					"   <div class='numeric__row display__flex__base-webkit' id='" + (parseInt(v)
							+ 1)
					+ "'>" +
					"      <span>V" + (parseInt(v) + 1) + " =</span>" +
					"      <div class='form-group sm-selection' style=''>" +
					"         <select class='selectpicker conditionalBranchingRequired' name='questionConditionBranchBoList["
					+ rowCount + "].questionConditionBranchBos[0].inputType' id='inputTypeId"
					+ (parseInt(
					...
					+ (parseInt(v) + 1) + "'>" +
					"         <input type='hidden' name='questionConditionBranchBoList[" + rowCount
					+ "].questionConditionBranchBos[0].sequenceNo' id='sequenceNoId" + (parseInt(v)
							+ 1)
					+ "'  value='" + (parseInt(v) + 1) + "'>" +
					"         <input type='hidden' name='questionConditionBranchBoList[" + rowCount
					...
					"            <input type='text' id='constantValId" + (parseInt(v) + 1)
					+ "' index='"
					+ (parseInt(v) + 1)
					...
					"         </div>" +
					"		 <div class='form-group sm__in'>" +
					"           <span class='delete vertical-align-middle remBtnDis pl-md align-span-center hide removeVaraiableFunct' index='"
					+ (parseInt(v) + 1) + "' count='0' ></span>" +
					"         </div>" +
					"   </div>" +
					"   <div class='numeric__row display__flex__base-webkit' id='" + (parseInt(v)
							+ 2)
					...
					"      <div class='form-group sm-selection' style=''>" +
					"         <select class='selectpicker conditionalBranchingRequired' name='questionConditionBranchBoList["
					+ rowCount + "].questionConditionBranchBos[1].inputType' id='inputTypeId"
					+ (parseInt(
					...
					+ (parseInt(v) + 2) + "' >" +
					"         <input type='hidden' name='questionConditionBranchBoList[" + rowCount
					+ "].questionConditionBranchBos[1].sequenceNo' id='sequenceNoId" + (parseInt(v)
							+ 2)
					+ "' value='" + (parseInt(v) + 2) + "'>" +
					"         <input type='hidden' name='questionConditionBranchBoList[" + rowCount
					+ "].questionConditionBranchBos[1].parentSequenceNo'id='parentSequenceNoId"
					+ (parseInt(v) + 2) + "' value='" + parseInt(index) + "' >" +
					"         <div class='add_varible add_var_hide addVariableFunct' parentIndex=" + parseInt(index)
					+ " index='" + rowCount
					+ "' id='addVaraiable1'>+ Add Variable</div>" +
					"      </div>" +
					"         <div class='form-group sm__in add_var_hide'>" +
					"            <input type='text' id='constantValId" + (parseInt(v) + 2)
					+ "' index='"
					+ (parseInt(v) + 2)
					+ "' class='constant form-control add_var_hide' value='' onkeypress='return isNumberKey(event)'/>"
					+
	...
	function selectFunction(item) {
		...
		if (typeof previousInputTypeValue != 'undefined' && previousInputTypeValue != null
			...
			if (previousInputTypeValue == "+" || previousInputTypeValue == "*") {
					...
					callback: function (result) {
						if (result) {
							...
							var lastSeqenceNO = parseInt(
									$("#rootId" + index + " .numeric__row").last().find(
											'select').attr("count"));
							if (value == '+' || value == '*') {
								$("#rootId" + index + " .numeric__row").last().removeClass(
										'display__flex__base-webkit').addClass(
										'display__flex__base');
								$("#rootId" + index + " .numeric__row #addVaraiable"
										+ lastSeqenceNO).removeClass('add_var_hide');
							} else {
								$("#rootId" + index + " .numeric__row #addVaraiable"
										+ lastSeqenceNO).addClass(
										'add_var_hide');
								$("#rootId" + index + " .numeric__row").last().removeClass(
										'display__flex__base').addClass(
										'display__flex__base-webkit');
							}
							createFormula();
						} else {
				...
				$("#previousInputTypeValueId" + count).val(value);
				var lastSeqenceNO = parseInt(
						$("#rootId" + index + " .numeric__row").last().find('select').attr(
								"count"));
				if (value == '+' || value == '*') {
					$("#rootId" + index + " .numeric__row #addVaraiable"
							+ lastSeqenceNO).removeClass(
							'add_var_hide');
					$("#rootId" + index + " .numeric__row").last().removeClass(
	...
	$(document).on('click', ".addVariableFunct", function() {
	//function addVariable(item) {
		var index = parseInt($(this).attr('index'));
		var rowCount = parseInt($('.numeric__section').length);
		var total = maxSquenceValue();
		var parent_index = parseInt($(this).attr('parentIndex'));
		var count = parseInt(
		...
		var addVar = "<div class='numeric__row display__flex__base' id='" + (parseInt(v)) + "'>" +
				...
				+ "].questionConditionBranchBos[" + count
				+ "].inputTypeValue' id='inputSubTypeValueId"
				+ (parseInt(v)) + "' >" +
				" 	   <input type='hidden' name='questionConditionBranchBoList[" + index
				...
				"	   <input type='hidden' name='questionConditionBranchBoList[" + index
				+ "].questionConditionBranchBos[" + count
				+ "].parentSequenceNo' id='parentSequenceNoId"
				+ (parseInt(v)) + "' value='" + parseInt(parent_index) + "'>" +
				"     <div class='add_varible addVariableFunct' parentIndex=" + parseInt(parent_index) + " index='"
				+ index + "' id='addVaraiable" + count
				+ "'>+ Add Variable</div> " +
				"   </div>" +
				"   <div class='form-group sm__in add_var_hide'>" +
				"      <input type='text' id='constantValId" + (parseInt(v)) + "' index='"
				+ (parseInt(
						v))
				...
				"   </div>" +
				"   <div class='form-group sm__in'>" +
				"           <span class='delete vertical-align-middle remBtnDis pl-md align-span-center removeVaraiableFunct' index='"
				+ (parseInt(v)) + "' count='" + count + "' ></span>" +
				"   </div>" +
				"</div>";
		$(this).parents(".numeric__row").after(addVar);
		$(this).addClass('add_var_hide');
		$('.selectpicker').selectpicker('refresh');
		$(".numeric__loop").parent().removeClass("has-danger").removeClass("has-error");
		$(".numeric__loop").parent().find(".help-block").empty();
		$(".numeric__loop").parents("form").validator("destroy");
	...
	$(document).on('click', ".removeVaraiableFunct", function() {
			...
			success: function (data) {
				...
				if (language !== 'en') {
					...
					if (responseTypeId.text().trim() === 'Date') {
						$('#anchorTextId, #useAnchorDateId').addClass('ml-disabled').attr(
								'disabled', true);
					}

					$('[name="questionReponseTypeBo.vertical"]').addClass('ml-disabled').attr(
							'disabled',
							true);
					...
					if (responseType !== '' && responseType !== 'Select') {
						$('#' + responseType.replaceAll(' ', '')).find(
							...
							if (!$(this).hasClass('lang-specific')) {
								...
								if (this.nodeName !== undefined && this.nodeName.toLowerCase()
										=== 'select') {
									let id = this.id;
									if (id !== undefined && id !== '') {
					...
					$('.sm-thumb-btn, .remBtnDis, .addbtn, #addFormula, .switch').addClass(
							'cursor-none');
					...
					if (previousResponseType !== '' && (previousResponseType !== $(
							'#responseTypeId').val())) {
						$('#statDisplayNameId').val('');
						$('#statDisplayUnitsId').val('');
						$('#chartTitleId').val('');
						...
						if (respType === '1' || respType === '2') {
							...
							$('#' + idMin).val('');
							$('#' + idMax).val('');
						} else if (respType === '3' || respType === '4' || respType === '5'
								|| respType
								=== '6') {
							let className = '';
							if (respType === '3')
								...
								$('[name="questionReponseTypeBo.otherPlaceholderText"]').val('');
								let i = 0;
								$(className).find('textarea.lang-specific').each(
										function (index, ele) {
											let id = ele.getAttribute('id');
											$('#' + id).val('');
											i++;
					...
					// if response type matches
						...
						if (respType === '1' || respType === '2') {
							...
							if (respType === '3')
								...
								$('#textchoiceOtherId').attr('disabled', true);
								let textChoiceDescription = $('#mlTextChoiceDescription',
										htmlData).val();
								...
								$(className).find('textarea.lang-specific').each(
										function (index, ele) {
											let txtValue = (txtDescriptionArray[i] !== undefined
													&& txtDescriptionArray[i]
													!= null
													&& txtDescriptionArray[i] !== '')
													? txtDescriptionArray[i] : '';
											let id = ele.getAttribute('id');
					...
					if (responseTypeId.text().trim() === 'Date') {
						$('#anchorTextId, #useAnchorDateId').removeClass('ml-disabled').attr(
								'disabled', false);
					}

					// validationExceptTextId if this has property disabled do not enable
					$('[name="questionReponseTypeBo.vertical"]').removeClass('ml-disabled').attr(
							'disabled',
							false);
					let responseType = responseTypeId.text().trim();
					if (responseType !== '' && responseType !== 'Select') {
					...
					$('.sm-thumb-btn, .remBtnDis, .addbtn, #addFormula, .switch').removeClass(
							'cursor-none');
					...
					if (respType === '1' || respType === '2') {
						...
						if (respType === '3')
							...
							$('.text-choice').find(
									'input.lang-specific, textarea.lang-specific').each(
									function (index, ele) {
						...
						if (respType === '8') {
							...
							id = 'textPlaceholderId';
							$('#validationExceptTextId').val(
									$('#validationExceptTextId', htmlData).val());
					...
					if (dv.is(':checked')) {
						$('.deletable').remove();
						$('#logicDiv').find('div.bootstrap-select, input, select').each(
								function () {
									$(this).addClass('ml-disabled');
						...
						$('#destinationTrueAsGroup, #preLoadSurveyId').val('').selectpicker(
								'refresh');
...
// alert('working ');
	...
	$('#addFormula').on('click', function () {
		...
		let formula =
				...
				+ count + '" name="preLoadLogicBeans[' + count
				+ '].inputValue" placeholder="Enter" />' +
	...
	function disablePreLoadLogic() {
		...
		logicDiv.find('div.bootstrap-select, input, select').each(function () {
			...
			if ($(this).is("select")) {
				...
				$(this).parent().parent().removeClass('has-error has-danger').find(
						".help-block").empty();
			}
			if ($(this).is("input")) {
					...
					if (message === 'SUCCESS') {
						...
						if (options != null && options.length > 0) {
							$.each(options, function (index, option) {
								...
								.attr("data-type", 'step')
								.text("Step " + (option.sequenceNo) + " : "
										+ option.stepShortTitle);
								id.append($option);
							});
						}
						if (type === 'preload') {
							id.append(
									'<option data-type="step" value="0">Completion Step</option>');
							if (!$('#differentSurveyPreLoad').is(':checked')) {
								<c:forEach items="${groupsListPostLoad}" var="group" varStatus="status">
								id.append(
										'<option data-type="group" value="${group.id}" id="selectGroup${group.id}">'
										+
										'Group :  ${group.groupName}&nbsp;' +
										'</option>');
								</c:forEach>
	...
	//function submitPiping() {
		if (validatePipingRequiredFields()) {
			if ($('#stepId').val() !== '') {
				...
				pipingObject.pipingSourceQuestionKey = $('#sourceQuestion option:selected').attr(
						'data-id');
				if ($('#differentSurvey').is(':checked')) {
	...
	function validatePipingRequiredFields() {
		...
		if (language !== null && language !== undefined && language !== 'en') {
			...
			$('select.req, input.req').each(function () {
				...
				if ($(this).val() === '') {
					if (id !== 'surveyId' || (id === 'surveyId' && $('#differentSurvey').is(
							':checked'))) {
						parent.addClass('has-error has-danger').find(".help-block")
						.empty()
						.append($("<ul><li> </li></ul>")
