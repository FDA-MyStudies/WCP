    ...
    <div class="logout">
        <div class="dis-line pull-right ml-md line34">
            <a href="/fdahpStudyDesigner/sessionOut.do"
               class="blue-link text-weight-normal text-uppercase"><span class="white__text">sign Out</span>
                <!-- <span class="ml-xs"><img src="/fdahpStudyDesigner/images/icons/logout.png"/></span> -->
            </a>
        </div>
    </div>
    <div class="logo__ll">
